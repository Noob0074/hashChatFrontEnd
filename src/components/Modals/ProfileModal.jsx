  ...
  return (
    <>
      <div className="modal-overlay" onClick={(e) => {
        ...
        <div className="modal-content animate-slide-up max-w-[420px] p-0 overflow-hidden flex flex-col max-h-[90vh]">
          {/* Static Header */}
          <div className="flex justify-between items-center px-6 py-4 border-b border-dark-800 bg-dark-900/50 backdrop-blur-md">
          ...
          {/* Scrollable Body */}
          <div className="flex-1 overflow-y-auto custom-scrollbar overflow-x-hidden p-6">
